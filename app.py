...
## Creating chunks of the Texts read from the pdfs
...
## Creating vectors using Google Embedding Model
...
def main():
    st.set_page_config(page_title="QA with PDF")
    st.header("QA with PDF using Gemini")
